...
| Modbus 串口 | 3 路 | USART1 (USB, 19200), USART2 (ESP, 19200), UART5 (STM, 115200) |
...
| 从机 | 串口 | 波特率 | 从机地址 | 用途 |
|------|------|--------|----------|------|
| `mbsUSB` | USART1 | 19200 | 0x01 | 与上位机 Kickpi K7 通信（主通道） |
| `mbsESP` | USART2 | 19200 | 0x01 | 预留（ESP 无线模块） |
